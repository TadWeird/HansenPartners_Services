...
function Searchbar() {
    return (
        <form className="w-full px-4 mx-auto sticky top-0 z-10 bg-black/75 backdrop-blur-sm flex justify-center items-center space-x-4 py-2">
            <label htmlFor="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
            <div className="relative w-full max-w-screen-xl">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                    <svg className="w-5 h-5 text-zinc-200" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                        <path 
                            stroke="#E4E4E7" // This corresponds to the zinc-200 color in Tailwind CSS
                            strokeLinecap="round" 
