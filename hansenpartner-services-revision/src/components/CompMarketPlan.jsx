      ...
      <Carousel
        ...
        leftControl={
          <span className="absolute top-0 start-0 z-30 flex items-center justify-center h-full px-4 cursor-pointer group focus:outline-none">
            <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-REyellow group-hover:bg-zinc-200 group-focus:ring-2 group-focus:ring-black">
